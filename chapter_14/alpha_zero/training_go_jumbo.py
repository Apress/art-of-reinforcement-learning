...
flags.DEFINE_integer(
    "num_res_blocks", 19, "Number of residual blocks in the neural network."
)
flags.DEFINE_integer(
    "num_filters", 256, "Number of filters for the conv2d layers in the neural network."
)
flags.DEFINE_integer(
    "num_fc_units",
    256,
...
flags.DEFINE_integer(
    "min_games", 50000, "Collect number of self-play games before learning starts."
)
flags.DEFINE_integer(
    "games_per_ckpt",
    25000,
