...
flags.DEFINE_string('black_ckpt', './checkpoints/go/9x9_11b128/training_steps_154000.ckpt', 'Load the checkpoint file for black player.')
flags.DEFINE_string('white_ckpt', './checkpoints/go/9x9_11b128/training_steps_154000.ckpt', 'Load the checkpoint file for white player.')
